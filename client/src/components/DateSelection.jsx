...
const DateSelection = ({
  ...
  const handleDateClick = async (day) => {
    ...
    try {
      const response = await fetch(
        `http://localhost:5000/api/appointments/slots?date=${targetDate}`,
      );
  ...
  return (
    <div className="wizard-content">
      ...
      {/* Slots Panel */}
      <div
        className="panel panel-right slots-panel"
        style={{
          backgroundColor: selectedDate ? "white" : "#fafafa",
          display: "flex",
      ...
      >
        {!selectedDate ? (
          ...
          <div
            className="slots-container animation-fade-in"
              ...
              <div className="slot-section" style={{ marginBottom: "24px" }}>
                ...
                >
                  ...
                  <span style={{ fontSize: "12px", color: "#6B7280" }}>
                    {availableSlots.morning.filter((s) => s.available).length}{" "}
                    available
                  </span>
                </div>
              ...
              availableSlots.afternoon.length > 0 && (
                <div className="slot-section" style={{ marginBottom: "24px" }}>
                  ...
                  >
                    ...
                    <span style={{ fontSize: "12px", color: "#6B7280" }}>
                      {
                        availableSlots.afternoon.filter((s) => s.available)
                          .length
                      }{" "}
                      available
                    </span>
            ...
            {availableSlots.evening && availableSlots.evening.length > 0 && (
              <div className="slot-section">
                ...
                >
                  ...
                  <span style={{ fontSize: "12px", color: "#6B7280" }}>
                    {availableSlots.evening.filter((s) => s.available).length}{" "}
                    available
                  </span>
                </div>
                <div className="slots-grid">
